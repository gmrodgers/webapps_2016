...
\begin{subfigure}{.5\textwidth}
  \centering
	\includegraphics[scale=0.08]{../Pictures/slacl.png}
  \caption{Slack App}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
	\includegraphics[scale=0.08]{../Pictures/trello.png}  
  \caption{Trello App}
  \label{fig:sub2}
\end{subfigure}
\label{fig:test}
...
\begin{subfigure}{.5\textwidth}
  \centering
	\includegraphics[scale=0.09]{../Pictures/slacl.png}
  \caption{Slack App}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
	\includegraphics[scale=0.09]{../Pictures/trello.png}  
  \caption{Trello App}
  \label{fig:sub2}
\end{subfigure}
\label{fig:test}
